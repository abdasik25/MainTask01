...
public class GetElementsTest {
    ...
    public GetElementsTest(VectorBasicController vectorBasicController, double[] elements, double[] expected) {
    ...
    public static Collection<Object[]> getParameters() {
        ...
        return Arrays.asList(new Object[][]{
                {new VectorBasicController(new VectorModelDataService()), array1, new double[]{}},
                {new VectorBasicController(new VectorModelDataService()), array2, new double[]{7, 2, 3, 4, 5}},
                {new VectorBasicController(new VectorModelDataService()), array3, new double[]{9, 2, 3, 4, 5, 6, 7}},
        });
    }
