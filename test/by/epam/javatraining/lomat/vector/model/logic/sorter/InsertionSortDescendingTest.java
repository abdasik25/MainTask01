...
public class InsertionSortDescendingTest {
    ...
    public InsertionSortDescendingTest(VectorBasicController vectorBasicController, VectorModelDataService vectorModelDataService,
    ...
    public void insertionSortDescendingTest() {
        VectorSorter.insertionSortDescending(vectorModelDataService, vectorBasicController);
