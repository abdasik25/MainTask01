...
public class MergeSortDescendingTest {
    ...
    public MergeSortDescendingTest(VectorBasicController vectorBasicController, VectorModelDataService vectorModelDataService,
    ...
    public void mergeSortDescendingTest() {
        VectorSorter.mergeSortDescending(vectorModelDataService, 0,
                vectorBasicController.getVectorCapacity() - 1);
